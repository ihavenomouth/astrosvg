...
const cambiarEjCurvaQ=()=>{
  document.querySelector("#svgEjCurvaQQ").setAttribute("d", `M20 80 Q ${frmEjCurvaQ.txtXEjQ.value} ${frmEjCurvaQ.txtYEjQ.value} 80 80`);
...
const cambiarEjCurvaC=()=>{
  svgEjCurvaCC.setAttribute("d", `M20 60 C ${frmEjCurvaC.txtXEjC.value} ${frmEjCurvaC.txtYEjC.value} ${frmEjCurvaC.txtXEjC2.value} ${frmEjCurvaC.txtYEjC2.value} 80 60`);
